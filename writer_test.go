...
var writerTests = []struct {
...
}{
	{
		...
		dump: `row group 0
--------------------------------------------------------------------------------
first_name:  BINARY UNCOMPRESSED DO:0 FPO:4 SZ:75/75/1.00 VC:3 ENC:PLAIN [more]...
last_name:   BINARY UNCOMPRESSED DO:0 FPO:79 SZ:98/98/1.00 VC:3 ENC:PLAIN [more]...
