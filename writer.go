...
func newColumnChunkWriter(writer io.Writer, codec compress.Codec, enc encoding.Encoding, maxRepetitionLevel, maxDefinitionLevel int32, values PageBuffer) *columnChunkWriter {
